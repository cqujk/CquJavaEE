...
import static org.web2.utils.TokenUtil.checkToken;
...
public class TokenFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        System.out.println("Web2 filter get  " + httpRequest.getRequestURI());
        // 从请求中获取 token
        Optional<Cookie> tokenCookie = CookieUtil.getCookieByName(httpRequest, "token");
        System.out.println("Web2 filter get cookie "+ tokenCookie);
